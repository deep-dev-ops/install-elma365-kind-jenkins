...
ELMA365_EXTRA_ARGS="ELMA365_MAX_GRPC_MESSAGE_SIZE:'10388608' ELMA365_SCRIPT_COMPILE_TTL:4m"
        ...
        stage('3. Search and uninstall current ELMA365') {
            ...
            steps {
                script {
                    ...
                    sshCommand remote: RemoteConnectionSsh, command: " yes | sudo ${env.RemoteDirName}/elma365-docker.sh"
                }
            }
        }
